...
*.Report: Contains the visual layout and page configurations.

🚀 How to View This Project
Download or clone the repository.

Open the .pbip file (or .pbit if included) in Power BI Desktop.

(Optional) If you wish to inspect the data model, you can explore the metadata folders directly here on GitHub.
